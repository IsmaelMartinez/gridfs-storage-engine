...
//function saveOrUpdateFile(req, file, cb) {
//    'use strict';
//    gfs.collection().findOne(
//        {
//            'metadata.mac': req.query.mac,
//            'metadata.type': req.query.type,
//            'metadata.date': req.query.date,
//            filename: req.query.filename},{
//        },{sort : [['uploadDate', 'descending']]}, function (err, dbFile) {
//            streamFileToGridFS(req, file, cb);
//            if (dbFile) {
//                removeFile(dbFile._id);
//            }
//        });
//}
